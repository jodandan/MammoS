                            ...
                            <ListBox>
                                {studyData[currentIndex].notices.length > 0 ? (
                                    studyData[currentIndex].notices.map((notice, index) => {
                                        ...
                                        const updatedAt = new Date(notice.updatedAt ? notice.updatedAt : notice.createdAt);
                                        // 연도, 월, 일을 추출
                                ...
                                {currentPage > 0 && (
                                    <PaginationContainer>
                                        ...
                                        <PageButton onClick={() => handlePageChange(currentPage + 1)} disabled={indexOfLastNotice >= studyData[currentIndex]?.notices.length}>
                                            다음
                                        </PageButton>
                                    </PaginationContainer>
                                )}
